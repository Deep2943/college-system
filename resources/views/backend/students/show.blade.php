                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex flex-wrap fw-bold fs-6 mb-md-4 pe-2 flex-column flex-md-row">
                                    ...
                                    <!--end::Svg Icon-->{{ $student->user->email }}</a>
                                    <div class="d-flex align-items-center text-gray-400 ms-md-5 ms-0 mb-2">
                                        ...
                                        <!--end::Svg Icon-->{{ $student->current_address }}</div>
                                </div>
                                <!--end::Info-->
                            </div>
                            <!--end::User-->
                ...
                <div class="row gy-5">
                    <div class="col-lg-6">
                        <div class="d-flex flex-wrap flex-stack">
                            ...
                            <div class="row mb-5 w-100">
                                <label class="col-lg-4 fw-bold fs-6 text-muted">Parent Phone:</label>
                                <div class="col-lg-8">
                            ...
                            <div class="row w-100">
                                <label class="col-lg-4 fw-bold fs-6 text-muted">Parent Address:</label>
                                <div class="col-lg-8">
